...
import com.hyperadx.hypernetwork.ads.internal.util.HADLog;
...
public abstract  class HyperadxRewardedMopub extends CustomEventRewardedAd {
    ...
    protected void loadWithSdkInitialized(@NonNull final Activity activity,
        ...
        if (rewardedAdCurrencyName instanceof String) {
            ...
            HADLog.e("mRewardedAdCurrencyName="+mRewardedAdCurrencyName);
        } else {
        ...
        if (rewardedAdCurrencyAmount instanceof String) {
            try {
                ...
                HADLog.e("mRewardedAdCurrencyAmount="+mRewardedAdCurrencyAmount);
